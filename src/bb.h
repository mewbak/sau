...
static u1 *getPalette(int idx) {
  switch(idx) {
  case 0: return MainPalette;
  case 1: return SpringPalette;
  case 2: return MissionPalette;
  case 3: return LoadingPalette;
  case 4: return TitlePalette;
  case 5: return SummerPalette;
  case 6: return AutumnPalette;
  case 7: return WinterPalette;
  }
  printf("Invalid palette index");
  abort();
  return MainPalette;
}
